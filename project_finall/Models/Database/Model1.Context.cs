...
namespace project_finall.Models.Database
{
    ...
    public partial class YS_DESIGNSEntities : DbContext
    {
        public YS_DESIGNSEntities()
            : base("name=YS_DESIGNSEntities")
        {
        }
        ...
        public virtual DbSet<PhongThuy> PhongThuys { get; set; }
